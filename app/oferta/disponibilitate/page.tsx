  ...
  function trimiteLiberiInOferta() {
    ...
    const linii_complete = liberi.map((ra: any) => {
      ...
      return {
        ...
        leiKm: rd.lei_km || 0, transportMoneda: rd.transport_moneda || 'lei', useMarja: true, cazare: rd.cazare || '', persoane: rd.nr_persoane || 0,
  ...
  if (!authed) return (
    <div style={{minHeight:'100vh', background:bg, display:'flex', alignItems:'center', justifyContent:'center', fontFamily:F, padding:'20px'}}>
      <div style={{background:UI.card, borderRadius:UI.radius, padding:'32px', width:'360px', boxShadow:UI.shadow}}>
        ...
        <Link href="/oferta" style={{display:'block', textAlign:'center', marginTop:'16px', fontSize:'13px', color:UI.sub, textDecoration:'none'}}>← Înapoi</Link>
      </div>
    </div>
  )
      ...
      <div style={{maxWidth:'980px', margin:'0 auto'}}>
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px', flexWrap:'wrap', gap:'10px'}}>
          ...
          <div style={{display:'flex', gap:'8px', alignItems:'center', flexWrap:'nowrap', overflowX:'auto', WebkitOverflowScrolling:'touch', maxWidth:'100%', paddingBottom:'2px'}}>
            ...
            <span style={{fontSize:'13px', color:'#1c1917', fontWeight:800, background:'#ebe9e6', border:'1.5px solid #ebe9e6', borderRadius:'10px', padding:'10px 13px', whiteSpace:'nowrap', flexShrink:0}}><span style={{display:'inline-flex', alignItems:'center', gap:'6px'}}><CalendarSearch size={15} strokeWidth={2.2} /> Calendar</span></span>
