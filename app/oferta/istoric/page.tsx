      ...
      <div style={{maxWidth:'1080px', margin:'0 auto', position:'relative', zIndex:1}}>
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px'}}>
          ...
          <div style={{display:'flex', gap:'8px', alignItems:'center', flexWrap:'nowrap', overflowX:'auto', WebkitOverflowScrolling:'touch', maxWidth:'100%', paddingBottom:'2px'}}>
            ...
            <Link href="/oferta/fisa" style={{fontSize:'13px', color:'#1c1917', fontWeight:700, background:'white', border:'1.5px solid #ececec', borderRadius:'10px', padding:'10px 13px', textDecoration:'none', whiteSpace:'nowrap', flexShrink:0}}><span style={{display:'inline-flex', alignItems:'center', gap:'6px'}}><FileText size={15} strokeWidth={2.2} /> Fișă</span></Link>
          </div>
        </div>
