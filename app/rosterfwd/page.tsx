...
export default function RosterFwdGate() {
  ...
  return (
    <div style={{minHeight:'100vh', background:'#101014', fontFamily:F, display:'flex', alignItems:'center', justifyContent:'center', padding:'20px'}}>
      <div style={{width:'100%', maxWidth:'400px', textAlign:'center'}}>
        ...
        <div style={{fontSize:'13px', color:'#a8a29e', fontWeight:600, marginTop:'6px', marginBottom:'28px'}}>Roster Forward · acces parteneri</div>
        ...
        <div style={{fontSize:'11.5px', color:'#57534e', fontWeight:500, marginTop:'22px', lineHeight:1.6}}>
          ...
          <a href={'https://wa.me/40751144109?text=' + encodeURIComponent('Buna Bogdan, as vrea acces la rosterul Forward cu preturi')} target="_blank" style={{color:'#059669', fontWeight:700, textDecoration:'none'}}>Cere-l pe WhatsApp</a>
        </div>
      </div>
    </div>
  )
