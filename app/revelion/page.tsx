...
export default function RevelionGate() {
  ...
  return (
    <div style={{minHeight:'100vh', background:'#101014', fontFamily:F, display:'flex', alignItems:'center', justifyContent:'center', padding:'20px'}}>
      <div style={{width:'100%', maxWidth:'400px', textAlign:'center'}}>
        ...
        <div style={{fontSize:'13px', color:'#eacda3', fontWeight:700, marginTop:'6px'}}>Revelion 2027</div>
        <div style={{fontSize:'12px', color:'#a8a29e', fontWeight:500, marginTop:'4px', marginBottom:'28px'}}>Onorarii si logistica de sarbatori</div>
        ...
        <button onClick={intra} disabled={!cod.trim()}
          ...
          Vezi oferta de Revelion
        </button>
        <div style={{fontSize:'11.5px', color:'#57534e', fontWeight:500, marginTop:'22px', lineHeight:1.6}}>
          Nu ai cod de acces?<br/>
          <a href={'https://wa.me/40751144109?text=' + encodeURIComponent('Buna Bogdan, as vrea acces la oferta de Revelion 2027')} target="_blank" style={{color:'#059669', fontWeight:700, textDecoration:'none'}}>Cere-l pe WhatsApp</a>
        </div>
      </div>
    </div>
  )
